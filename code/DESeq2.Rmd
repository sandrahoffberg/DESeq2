...
```{r MA plot}
MA <- plotMA(deseq2Results, alpha=alpha, main=paste("MA plot with alpha of", alpha, sep=" "), colNonSig=colNonSig, colSig=colSig)
MA
ggsave(file="../results/MA_plot.svg", plot=MA, width=10, height=8)
...
ggsave(file="../results/ENSG00000080910.svg", plot=g, width=10, height=8)
ggsave(file="../results/ENSG00000142959.svg", plot=h, width=10, height=8)
ggsave(file="../results/ENSG00000196611.svg", plot=i, width=10, height=8)
ggsave(file="../results/ENSG00000122641.svg", plot=j, width=10, height=8)
ggsave(file="../results/ENSG00000168748.svg", plot=k, width=10, height=8)
ggsave(file="../results/ENSG00000167767.svg", plot=l, width=10, height=8)
...
PCA <- plotPCA(vsdata, intgroup="tissueType") + scale_color_manual(values=c("red","forestgreen","blue")) + scale_size_manual(values=1)
PCA
ggsave(file="../results/PCA.svg", plot=PCA, width=10, height=8)
